...
function save_search_results(){
    if(isset($_REQUEST['origin']) && isset($_REQUEST['username']) && isset($_REQUEST['destination']) && isset($_REQUEST['distance_in_kilo']) &&
    isset($_REQUEST['distance_in_mile']) && isset($_REQUEST['duration_text']) && isset($_REQUEST['taxi_fare'])
    ){
